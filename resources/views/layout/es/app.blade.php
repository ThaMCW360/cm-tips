...
<!-- header -->
    ...
    <footer class="text-center">
        ...
        <div class="row cookies-inner">
            ...
            <div class="col-lg-8 content">Utilizamos cookies para facilitar el uso de nuestro sitio web y con fines estadísticos. Si no está bloqueando estos archivos, acepta su uso y almacenamiento en la memoria del dispositivo. Recuerde que usted mismo puede administrar las cookies cambiando la configuración de su navegador.</div>
            <div class="col-lg-2 col-12 text-center"><button onclick="dismissCookie('cookies')" class="btn">Aceptar</button></div>
        </div>
    </div>
