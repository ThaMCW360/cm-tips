...
<!-- header -->
    ...
    <footer class="text-center">
        ...
        <div class="row cookies-inner">
            ...
            <div class="col-lg-8 content">Używamy plików cookies, aby ułatwić korzystanie z naszego serwisu oraz w celach statystycznych. Jeżeli nie blokujesz tych plików, wyrażasz zgodę na ich używanie i zapisywanie w pamięci urządzenia. Pamiętaj, że możesz samodzielnie zarządzać plikami cookies zmieniając ustawienia swojej przeglądarki.</div>
            <div class="col-lg-2 col-12 text-center"><button onclick="dismissCookie('cookies')" class="btn">Akceptuj</button></div>
        </div>
    </div>
