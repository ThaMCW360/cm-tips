...
<!-- header -->
    ...
    <footer class="text-center">
        ...
        <div class="row cookies-inner">
            ...
            <div class="col-lg-8 content">Wir verwenden Cookies, um die Nutzung unserer Website zu erleichtern und zu statistischen Zwecken. Wenn Sie diese Dateien nicht blockieren, stimmen Sie deren Verwendung und Speicherung im Gerätespeicher zu. Denken Sie daran, dass Sie Cookies selbst verwalten können, indem Sie Ihre Browsereinstellungen ändern.</div>
            <div class="col-lg-2 col-12 text-center"><button onclick="dismissCookie('cookies')" class="btn">Annehmen</button></div>
        </div>
    </div>
